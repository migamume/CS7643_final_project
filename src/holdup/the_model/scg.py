#### from https://github.com/joekelley120/PyTorchScaledConjugateGradient/blob/main/scg.py
...
class SCG(Optimizer):
    ...
    def __init__(self, params, _lambda=5.0e-7, sigma=5.0e-5, min_grad=1e-10, num_x=2):
